...
import id.vimona.demo.jetdevs_test.model.ErrorResponse;
import id.vimona.demo.jetdevs_test.model.FieldError;
...
public class RestExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> accessDeniedStatus(final AccessDeniedException exception) {
